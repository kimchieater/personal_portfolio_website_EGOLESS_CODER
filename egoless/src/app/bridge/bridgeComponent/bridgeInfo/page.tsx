...
const BridgeInfo = () => {
  ...
  const {scrollYProgress} = useScroll({
      target: scopeRef,
      offset: ["start 40%", '100% start'],
});

    return (
        <div className="relative">
        <motion.div ref={scopeRef}
        className="text-left absolute top-[100px] left-[50%] translate-x-[-50%] h-[350px] text-neutral-300 font-black flex flex-col gap-[2rem] sm:gap-[5rem] text-[1rem]  xl:text-[1.7rem] lg:text-[1.3rem] md:text-[1.2rem] sm:text-[1rem]" >
