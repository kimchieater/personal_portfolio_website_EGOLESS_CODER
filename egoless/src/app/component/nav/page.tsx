...
const Nav = () => {
  return(
    <div className="relative">
      <div className="fixed flex flex-col gap-2 cursor-pointer  z-[100] mx-auto left-[50%] translate-x-[-50%] md:hidden py-5">
        <div className="w-[50px] h-[5px] bg-neutral-200 rounded-sm"></div>
        <div className="w-[50px] h-[5px] bg-neutral-200 rounded-sm"></div>
        <div className="w-[50px] h-[5px] bg-neutral-200 rounded-sm"></div>
      </div>
