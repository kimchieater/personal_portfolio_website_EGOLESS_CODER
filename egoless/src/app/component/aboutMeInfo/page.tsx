...
const AboutMeInfo = ()=>{
  ...
  return(
    <div className="w-[1770px] h-3/4" ref={targetRef}>
      <motion.div className="text-neutral-300  mx-auto grid grid-cols-3 grid-rows-3 h-full p-5">
      <div>
        <motion.div 
      ...
      <motion.div className=" flex flex-col items-end place-self-center text-left row-start-3 col-start-3 lg:relative">
        <motion.div 
